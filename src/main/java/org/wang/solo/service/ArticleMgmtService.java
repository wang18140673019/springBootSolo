...
import org.wang.solo.event.EventTypes;
...
public class ArticleMgmtService {
    ...
    public void updateArticle(final JSONObject requestJSONObject) throws ServiceException {
        ...
        try {
            ...
            final String permalink = getPermalinkForUpdateArticle(oldArticle, article, oldArticle.optLong(Article.ARTICLE_CREATED));
            ...
            // Set date
            article.put(Article.ARTICLE_UPDATED, oldArticle.getLong(Article.ARTICLE_UPDATED));
     ...
     * </p>
     * <p>
     * The property(named {@value Article#ARTICLE_RANDOM_DOUBLE}) of the specified
    ...
    private void fillAutoProperties(final JSONObject oldArticle, final JSONObject article) throws JSONException {
        final long created = oldArticle.getLong(Article.ARTICLE_CREATED);
        article.put(Article.ARTICLE_CREATED, created);
        ...
        article.put(Article.ARTICLE_AUTHOR_ID, oldArticle.getString(Article.ARTICLE_AUTHOR_ID));
        article.put(Article.ARTICLE_RANDOM_DOUBLE, Math.random());
    }
