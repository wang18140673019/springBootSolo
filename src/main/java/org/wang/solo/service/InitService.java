...
import org.wang.solo.SoloServletListener;
import org.wang.solo.util.Images;
import org.wang.solo.util.Skins;
import org.wang.solo.util.Solos;
import org.wang.solo.util.Thumbnails;
import org.json.JSONArray;
import org.json.JSONException;
import org.json.JSONObject;
import org.wang.solo.model.*;
import org.wang.solo.repository.*;
...
public class InitService {
    ...
    private void helloWorld() throws Exception {
        ...
        article.put(Article.ARTICLE_EDITOR_TYPE, Option.DefaultPreference.DEFAULT_EDITOR_TYPE);
    ...
    private void initReplyNotificationTemplate() throws Exception {
        ...
        final JSONObject replyNotificationTemplate = new JSONObject(Option.DefaultPreference.DEFAULT_REPLY_NOTIFICATION_TEMPLATE);
    ...
    private void initPreference(final JSONObject requestJSONObject) throws Exception {
        ...
        noticeBoardOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_NOTICE_BOARD);
        ...
        metaDescriptionOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_META_DESCRIPTION);
        ...
        metaKeywordsOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_META_KEYWORDS);
        ...
        htmlHeadOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_HTML_HEAD);
        ...
        relevantArticlesDisplayCountOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_RELEVANT_ARTICLES_DISPLAY_COUNT);
        ...
        randomArticlesDisplayCountOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_RANDOM_ARTICLES_DISPLAY_COUNT);
        ...
        externalRelevantArticlesDisplayCountOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_EXTERNAL_RELEVANT_ARTICLES_DISPLAY_COUNT);
        ...
        mostViewArticleDisplayCountOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_MOST_VIEW_ARTICLES_DISPLAY_COUNT);
        ...
        articleListDisplayCountOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_ARTICLE_LIST_DISPLAY_COUNT);
        ...
        articleListPaginationWindowSizeOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_ARTICLE_LIST_PAGINATION_WINDOW_SIZE);
        ...
        mostUsedTagDisplayCountOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_MOST_USED_TAG_DISPLAY_COUNT);
        ...
        mostCommentArticleDisplayCountOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_MOST_COMMENT_ARTICLE_DISPLAY_COUNT);
        ...
        recentArticleDisplayCountOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_RECENT_ARTICLE_DISPLAY_COUNT);
        ...
        recentCommentDisplayCountOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_RECENT_COMMENT_DISPLAY_COUNT);
        ...
        blogSubtitleOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_BLOG_SUBTITLE);
        ...
        localeStringOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_LANGUAGE);
        ...
        enableArticleUpdateHintOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_ENABLE_ARTICLE_UPDATE_HINT);
        ...
        signsOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_SIGNS);
        ...
        timeZoneIdOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_TIME_ZONE);
        ...
        allowVisitDraftViaPermalinkOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_ALLOW_VISIT_DRAFT_VIA_PERMALINK);
        ...
        commentableOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_COMMENTABLE);
        ...
        articleListStyleOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_ARTICLE_LIST_STYLE);
        ...
        feedOutputModeOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_FEED_OUTPUT_MODE);
        ...
        feedOutputCntOpt.put(Option.OPTION_VALUE, Option.DefaultPreference.DEFAULT_FEED_OUTPUT_CNT);
